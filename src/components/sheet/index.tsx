...
export const Sheet = () => {
	return (
		...
		>
			<Drawer.Portal>
				<Drawer.Content class="fixed inset-x-0 bottom-0 z-50 flex h-full max-h-[calc(100svh-5rem)] flex-col overscroll-contain rounded-t-2xl bg-white px-2.5 shadow outline-none after:absolute after:inset-x-0 after:top-[calc(100%-1px)] after:h-1/2 after:bg-inherit data-transitioning:transition-transform data-transitioning:duration-500 data-transitioning:ease-[cubic-bezier(0.32,0.72,0,1)] md:select-none dark:bg-zinc-900">
					<ThemeToggle />
					<FindNearestButton />
